...
public class Alarm2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Alarm2.context = getApplicationContext();
        edalarm = findViewById(R.id.edalarm2);
    ...
    public void OnToggleClicked2(View view) {
        ...
        if (((ToggleButton) view).isChecked()) {
            Toast.makeText(Alarm2.this, "ALARM1 ON", Toast.LENGTH_SHORT).show();
            Calendar calendar = Calendar.getInstance();
            calendar.set(Calendar.HOUR_OF_DAY, alarmTimePicker.getCurrentHour());
            calendar.set(Calendar.MINUTE, alarmTimePicker.getCurrentMinute());

            Intent intent = new Intent(this, AlarmReciever2.class);
            ...
            Toast.makeText(Alarm2.this, "ALARM1 OFF", Toast.LENGTH_SHORT).show();
