...
public class Alarm1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Alarm1.context = getApplicationContext();
        edalarm = findViewById(R.id.edalarm1);
    ...
    public void OnToggleClicked1(View view) {
        ...
        if (((ToggleButton) view).isChecked()) {
            Toast.makeText(Alarm1.this, "ALARM1 ON", Toast.LENGTH_SHORT).show();
            ...
            Toast.makeText(Alarm1.this, "ALARM1 OFF", Toast.LENGTH_SHORT).show();
