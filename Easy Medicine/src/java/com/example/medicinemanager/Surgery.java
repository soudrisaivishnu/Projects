...
public class Surgery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GoogleSignInAccount acct = GoogleSignIn.getLastSignedInAccount(Surgery.this);
        if (acct != null) {
      ...
      //  linearLayout2 = findViewById(R.id.linearlayout3);
        ...
        for ( i = 0; i <30; i++) {
            DatabaseReference myRef = database.getReference(personId+"/"+"Surgery/Prescription"+i);
            myRef.addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    final TextView rowTextView = new TextView(Surgery.this);
                    final TextView rowTextView2 = new TextView(Surgery.this);
                    final TextView rowTextView1 = new TextView(Surgery.this);
